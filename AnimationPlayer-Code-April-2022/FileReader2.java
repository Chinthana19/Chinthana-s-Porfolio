...
public class FileReader2 {
    ...
    public static boolean runCondition = true;
    ...
    private void CommandReader() throws IOException {
        ...
        while (runCondition) {
            ...
            } else if (str.startsWith("Hide") || str.startsWith("Show") || str.startsWith("Jump") || str.startsWith("ChangeColor")) {
                counter--;
                getEffectInfo(str);
                counter++;
            } else if (str == null) {
    ...
    private void getEffectInfo(String str) throws IOException {
        ...
        if (str.startsWith("Hide")) {
            ...
            System.out.println("StartFrameHide: " + hide.getStartFrame());
            ...
            System.out.println("StartFrameShow: " + show.getStartFrame());
            ...
            System.out.println("Jump Made: " + jump.getStartFrame());
            ...
            System.out.println("ColorChange: " + changeColor.getStartFrame() + ":" + changeColor.getR());
